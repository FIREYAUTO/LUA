...
local reg={};
function sreg(n,v,s)if s == nil then s = 0;end;table.insert(reg,{n=n,v=v,s=s});end;
function ureg(n,nv,s)if s == nil then s = 0 end;for k,v in pairs(reg) do if v.n == n and v.s == s then v.v = nv;return;end;end;end;
